function number_to_words() {
	...
	if ( N == 0 )  { 
		shabda = 'आपने कोई नंबर इनपुट नहीं किये हैं। कृपया एक नंबर इनपुट करें! '  ;
		s1 = N + 2
	} 

	if ( N > 20 )  { 
		shabda = 'आपने 21 से अधिक अंकों की नंबर इनपुट किये है। कृपया 21 अंको तक ही नंबर लिखें!'  ;
		s1 = N + 2
	} 
	...
	while ( s1 <= N + 1 ) {
		...
		if ( current_digit_index == -1 )  { shabda = 'यह एक संख्या नहीं है। '  ;   s1 = N + 2 ;   }
		*/
		...
		if ( ( index_of_units_digit == -1 ) + ( index_of_tens_digit == -1 ) ) {
			shabda = 'यह एक संख्या नहीं है।'  ;   s1 = N + 2 ;  }
	...
	document.getElementById("Number_inWords").value = number_string + '\n' +shabda ; 
