function number_to_words() {
	...
	if ( N == 0 )  { 
		shabda = 'आपने कोई संख्या नहीं लिखें है! '  ;
		s1 = N + 2
	} 

	if ( N > 20 )  { 
		shabda = 'यह संख्या 21 से अधिक अंकों की है! '  ;
		s1 = N + 2
	} 
	...
	document.getElementById("Number_inWords").value = number_string + ' ( ' + shabda + ')'  ; 
